  ...
  return (
    <div className="bg-white dark:bg-custom-dark dark:text-gray-200 space-y-3 shadow-sm border border-gray-200 dark:border-gray-700 p-4 rounded-2xl flex flex-col">
      ...
      <form className="relative flex items-center w-full">
        ...
        <button className="p-2 bg-primary text-white rounded-3xl absolute end-1 hover:opacity-90 transition-opacity">
          <svg
      ...
      <nav>
        <ul className="space-y-2">
          <li>
            <Link
              href=""
              className="space-x-3 px-2 py-3 hover:bg-primary-50 transition duration-300 rounded flex items-center"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
              ...
              <span className="text-base">جدیدترین مطالب</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span className="text-base">علم و تکنولوژی</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span className="text-base">بازی ویدویی</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span className="text-base">کتاب و رمان</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span className="text-base">هنر و سینما</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span className="text-base">سبک زندگی</span>
            </Link>
          </li>
        </ul>
      </nav>
