          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            >
              ...
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                ...
                <p>
                  ...
                  استور و خدمات مرتبط با آن را تنظیم می‌کند. در صورت عدم موافقت
                  با هر بخش از این شرایط، لطفاً از استفاده از خدمات ما خودداری
                  کنید.
                </p>
                  ...
                  <div className="flex items-start space-x-3 ">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm">
                        شما مسئول حفظ محرمانگی اطلاعات حساب و رمز عبور خود
                        هستید.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-yellow-800 dark:text-yellow-300">
                        تکمیل فرآیند خرید به منزله تأیید سفارش و ایجاد تعهد
                        قانونی برای پرداخت است.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-red-700 dark:text-red-400 text-sm mt-1">
                        در صورت تأخیر در پرداخت، سفارش شما پس از ۲۴ ساعت لغو
                        خواهد شد.
                      </p>
                    </div>
                  </div>
            ...
            >
              ...
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-red-800 dark:text-red-300">
                        ما حق فسخ یا تعلیق دسترسی شما به خدمات را در صورت نقض
                        این شرایط استفاده، برای خود محفوظ می‌داریم.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 mt-4">
                  <p className="text-sm">
                    در صورت فسخ، دسترسی شما به حساب کاربری بلافاصله متوقف خواهد
                    شد و هرگونه تعهد مالی باقی‌مانده باید تسویه شود.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-blue-800 dark:text-blue-300">
                        ما حق به‌روزرسانی و تغییر این شرایط استفاده را در هر
                        زمان برای خود محفوظ می‌داریم.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-4 mt-4">
                  <p className="text-yellow-800 dark:text-yellow-300 text-sm">
                    تغییرات ۳۰ روز پس از اطلاع‌رسانی رسمی لازم‌الاجرا خواهند
                    بود. ادامه استفاده از خدمات پس از این مدت به منزله پذیرش
                    تغییرات است.
                  </p>
                </div>
              </div>
            ...
            >
              ...
              <div className="space-y-4 text-gray-700 dark:text-gray-300">
                <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                  <p>
                    این شرایط استفاده بر اساس قوانین جمهوری اسلامی ایران تنظیم
                    شده است و دادگاه‌های تهران صالح به رسیدگی به هرگونه اختلاف
                    ناشی از این شرایط خواهند بود.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-3 ">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm">
                        در صورت عدم حل اختلاف، طرفین می‌توانند به داوری متوسل
                        شوند
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 ">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm">
                        در نهایت، اختلاف از طریق دادگاه‌های تهران رسیدگی خواهد
                        شد
                      </p>
                    </div>
                  </div>
