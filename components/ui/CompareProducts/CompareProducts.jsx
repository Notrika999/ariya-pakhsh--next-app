      ...
      >
        <div className="modal-content bg-white dark:bg-zinc-900 dark:border dark:border-gray-600 rounded-xl p-6 shadow-lg max-w-200 w-[80%] mx-auto mt-[5%] animate-[modalopen_0.4s_ease]">
          ...
          <div className="flex justify-between items-center mb-4">
            ...
            <span className="close text-gray-500 hover:text-gray-700 dark:text-gray-300 dark:hover:text-gray-100 text-2xl cursor-pointer">
              &times;
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {/* <!-- Sample Product Card --> */}
            <div className="product-card bg-white dark:bg-zinc-800 border border-gray-200 dark:border-gray-600 rounded-lg p-4 cursor-pointer hover:shadow-md transition duration-300">
          ...
          <div className="mt-6 flex justify-end">
            <button className="bg-gray-300 dark:bg-gray-600 hover:bg-gray-400 dark:hover:bg-gray-500 text-gray-800 dark:text-gray-100 py-2 px-6 rounded-lg text-sm font-medium transition duration-300 me-2">
              انصراف
            </button>
            <button className="bg-primary-600 hover:bg-primary-700 text-white py-2 px-6 rounded-lg text-sm font-medium transition duration-300">
              تایید انتخاب
            </button>
          </div>
        </div>
