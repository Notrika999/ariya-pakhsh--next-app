export default function NavMobile() {
  return (
    //    <!-- NAV MOBILE -->
    <nav className="fixed lg:hidden block bottom-0 end-0 start-0 z-30 py-2 px-2 rounded-t-[30px] overflow-hidden bg-custom-light dark:bg-custom-dark before:content-[''] before:absolute before:top-0 before:right-0 before:w-full before:h-full before:opacity-30">
      <div className="flex justify-around items-baseline relative text-white dark:text-gray-100">
        ...
        <a
          ...
          className="flex flex-col items-center px-2 py-3 rounded-[15px] transition-all duration-300 relative"
        >
          <div className="w-[50px] h-[50px] flex items-center justify-center rounded-full mb-1 bg-primary dark:bg-[rgba(255,255,255,0.05)] relative">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
