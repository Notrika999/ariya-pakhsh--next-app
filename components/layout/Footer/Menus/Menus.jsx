...
export default function Menus() {
  const footerMenus = [
    {
      id: 1,
      title: "<strong> راهنمای </strong>خرید",
      subMenus: [
    ...
    },
    {
      ...
      subMenus: [
        { id: 1, title: "معرفی تخفیف ها", link: "#", new: false },
        { id: 2, title: "پرسش های متداول", link: "#", new: false },
        { id: 3, title: "چگونگی بازگشت کالا", link: "#", new: false },
        { id: 4, title: "حریم خصوصی", link: "#", new: false },
      ],
    },
    {
      id: 3,
      title: "<strong> مجموعه </strong>گاج",
      subMenus: [
        { id: 1, title: "گاجینو", link: "#", new: false },
        { id: 2, title: "دکتر آی کیو", link: "#", new: false },
        { id: 3, title: "مای گاج", link: "#", new: false },
        { id: 4, title: "گاج مگ", link: "#", new: false },
      ],
    },
    {
      id: 4,
                ...
                <div className="w-full lg:w-10/12">
                  <div className="pt-3 border-t border-gray-300 dark:border-gray-700">
                    <small className="text-gray-500 text-xs dark:text-gray-400">
                      گاج‌مارکت؛ مرکز خرید و فروش انواع کتاب‌های کمک درسی،
                      آموزشی، دانشگاهی، زبان‌های خارجی، عمومی، کودک و نوجوان
                      می‌باشد و مرجعی برای تهیه انواع لوازم‌التحریر مورد نیاز
                      برای دانش‌آموزان و دانشجویان، لوازم اداری برای شرکت‌ها و
                      سازمان‌ها و بازی‌های آموزشی برای تمامی سنین است.
                    </small>
                  </div>
                </div>
              </div>
