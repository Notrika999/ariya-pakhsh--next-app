...
export default function MegaMenu() {
  ...
  return (
    <div className="lg:grid gap-y-0 hidden relative grid-cols-12">
      <div className="xl:col-span-10 col-span-12 place-self-start">
        <nav className="flex gap-x-9 mt-10 items-center">
          {/* menu  */}
          <ul className="flex dark:text-white items-center space-x-8 tracking-tight">
      ...
      <div className="xl:col-span-2 xl:block hidden place-self-end place-items-center">
