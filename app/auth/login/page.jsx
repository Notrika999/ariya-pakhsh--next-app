...
import UserRegistration from "@/components/ui/auth/UserRegistration";
import ForgotPassword from "@/components/ui/auth/ForgotPassword";
import LoginWidthPassword from "@/components/ui/auth/LoginWidthPassword";

function loginPage() {
  const [step, setStep] = useState(1);
  const [loginWidthPassword, setLoginWidthPassword] = useState(false);
  return (
